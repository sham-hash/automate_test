...
function attachClientEvents(whatsappClient) {
    ...
    whatsappClient.on('auth_failure', (message) => {
        ...
        loadingMessage = String(message || 'WhatsApp authentication failed');
...
function waitForReady(whatsappClient) {
    if (readyAt) {
...
process.on('uncaughtException', (error) => {
    whatsappStatus = 'error';
    loadingMessage = error.message || 'Unexpected WhatsApp worker error';
    publishState();
